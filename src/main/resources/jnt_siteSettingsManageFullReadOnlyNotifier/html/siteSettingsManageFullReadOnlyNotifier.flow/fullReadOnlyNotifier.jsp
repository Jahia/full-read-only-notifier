...
<div>
    ...
    <div class="box-1">
        ...
        <form action="${actionUrl}" method="POST" id="fullReadOnlyNotifierForm">
            <input type="hidden" name="jcrNodeType" value="jnt:fullReadOnlyNotifier">
                ...
                <div class="container-fluid">
                    <div class="row-fluid">
                        <div class="span4">
                            ...
                            <textarea rows="10" name="content_off" form="fullReadOnlyNotifierForm" class="span12" id="fullReadOnlyNotifierContentOff">${fn:escapeXml(fullReadOnlyNotifierContentOff)}</textarea>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span4">
                            ...
                            <textarea rows="10" name="content_on" form="fullReadOnlyNotifierForm" class="span12" id="fullReadOnlyNotifierContentOn">${fn:escapeXml(fullReadOnlyNotifierContentOn)}</textarea>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <button class="btn" onclick="submitFullReadOnlyNotifierForm('cancel'); return false;">
