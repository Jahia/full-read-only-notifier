...
public class FullReadOnlyNotifierQueryExtension {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FullReadOnlyNotifierQueryExtension.class);
     ...
     * {@code FullReadOnlyNotifierMutationExtension#updateFronotifierSettings}.
     *
